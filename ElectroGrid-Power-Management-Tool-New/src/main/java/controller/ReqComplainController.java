...
public class ReqComplainController {
	...
	public String insertRequest(@FormParam("id") String id, @FormParam("customerID") String customerID
			,@FormParam("type") String type, @FormParam("description") String description) {
		String output = requestserv.insertRequest(new ReqComplain(id, customerID, type, description));
		return output;
	}
	...
	public String viewRequest() {
		Gson gson = new Gson();
		request = requestserv.viewRequest();
	...
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	@Produces(MediaType.TEXT_PLAIN)
	public String updateRequest(@PathParam("id") String id , @FormParam("customerID") String customerID,
			@FormParam("type") String type, @FormParam("description") String description) {
		String output = requestserv.updateRequest(id, new ReqComplain(
				null, customerID, type, description));
		return output;
	}
}
